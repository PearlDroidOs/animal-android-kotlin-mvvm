 ...
 * It will change when it is much view
 * one view per one viewModel
 *
...
class ListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //ViewModelProvider basically store a list model or a type of our view model and attaches it to the fragment
        //Handle when user rotate app, it will store value and view --> it will not recreate them before destroy
